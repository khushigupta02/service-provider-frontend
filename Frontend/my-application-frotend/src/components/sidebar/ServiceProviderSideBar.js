      ...
      <div className={`sidebar-content ${isCollapsed ? "collapsed" : ""}`}>
        <ul className="sidebar-nav">
          ...
          <li className="sidebar-nav-item">
            <Link className="sidebar-nav-link" to="/serviceProviderDashboard">
              <FaHome className="sidebar-icon mx-2" />
              Dashboard
            </Link>
          </li>
          <li className="sidebar-nav-item">
            <Link className="sidebar-nav-link" to="/serviceProviderNotification">
              <FaHome className="sidebar-icon mx-2" />
              Notification
            </Link>
          </li>
          <li className="sidebar-nav-item">
            <Link className="sidebar-nav-link" to="/serviceProviderBookingOverview">
              <FaHome className="sidebar-icon mx-2" />
              Booking Overview
            </Link>
          </li>
          <li className="sidebar-nav-item">
            <Link className="sidebar-nav-link" to="/serviceProviderHistory">
              <FaHome className="sidebar-icon mx-2" />
              Activity Log
            </Link>
          </li>
          {/* <li className="sidebar-nav-item">
            <Link className="sidebar-nav-link" to="/services">
