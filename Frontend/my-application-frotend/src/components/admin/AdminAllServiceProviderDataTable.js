...
const AdminAllServiceProviderDataTable = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/viewAllCustomer/Service%20Provider")
      .then((response) => {
  ...
  return (
    <div className="container-fluid mx-0 px-0">
      ...
      <Modal show={showEditUserModal} onHide={handleCloseEditUserModal}>
        <Modal.Header closeButton>
          <Modal.Title>Edit Service Provider</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {showEditUserModal && (
      ...
      <div className="row ">
        ...
        <div className="col-lg-10 col-md-10 col-sm-10 p-5">
          ...
          <h3 className="text-center">All Service Provider</h3>
...
export default AdminAllServiceProviderDataTable
